...
GLuint      tex_grass_pallette_UniLoc;
...
static const int PAL_SIZE = 1024;
GLubyte      tex_grass_colorArray[PAL_SIZE];
...
static void loadTex()
{
    ...
    tex_grass_pallette_UniLoc = glGetUniformLocation(gProgram->object(), "grasspalette_texture");
    ...
    for(int i = 0; i < PAL_SIZE; i++)
    {
        if(i < 90)
        {
        tex_grass_colorArray[i] = 0xff;
//        tex_grass_colorArray[3*i + 1] = 0xa0;
//        tex_grass_colorArray[3*i + 2] = 0x12;
        }
        else if(i < 180)
        {
            tex_grass_colorArray[i] = 0xc4;
//            tex_grass_colorArray[3*i + 1] = 0xf3;
//            tex_grass_colorArray[3*i + 2] = 0x25;
        }
        else
        {
            tex_grass_colorArray[i] = 0x11;
        }
...
//    glGenerateMipmap(GL_TEXTURE_1D);
    glUniform1i(tex_grass_pallette_UniLoc, tex_grass_pallette);
}
