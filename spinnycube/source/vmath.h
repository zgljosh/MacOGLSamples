...
//          v(_v[1], _v[2], _v[3])
    {
        uu.ss1.r = _v[0];
        uu.ss1.v = Tvec3<T>(_v[1], _v[2], _v[3]);
    }
...
//          v(_y, _z, _w)
    ...
    {
        return quaternion(uu.ss1.r + q.r, uu.ss1.v + q.v);
    }
    ...
    {
        return Tquaternion(-uu.ss1.r, -uu.ss1.v);
    }

    inline Tquaternion operator*(const T s) const
    {
        return Tquaternion(uu.a[0] * s, uu.a[1] * s, uu.a[2] * s, uu.a[3] * s);
    }
    ...
    inline matNM<T,4,4> asMatrix() const
    {
        ...
        const T xx = uu.ss2.x * uu.ss2.x;
        const T yy = uu.ss2.y * uu.ss2.y;
        const T zz = uu.ss2.z * uu.ss2.z;
        const T ww = uu.ss2.w * uu.ss2.w;
        const T xy = uu.ss2.x * uu.ss2.y;
        const T xz = uu.ss2.x * uu.ss2.z;
        const T xw = uu.ss2.x * uu.ss2.w;
        const T yz = uu.ss2.y * uu.ss2.z;
        const T yw = uu.ss2.y * uu.ss2.w;
        const T zw = uu.ss2.z * uu.ss2.w;
